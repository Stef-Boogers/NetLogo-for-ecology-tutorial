...
1. Install the latest version of NetLogo from the dedicated [website](https://ccl.northwestern.edu/netlogo/download.shtml).
2. Make sure the installation is successful and open NetLogo.
3. Open the well-documented [NetLogo dictionary](https://ccl.northwestern.edu/netlogo/docs/dictionary.html), which will answer most questions you have about specific algorithms.
4. Also open the [Interactive Dictionary](https://ccl.northwestern.edu/netlogo/bind/primitive/patches.html), which will answer all remaining questions with great examples.
6. Open up chatGPT or your LLM of choice.
7. After the presentation, you're ready to get started on the next section!<br> 
